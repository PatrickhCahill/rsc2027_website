...
export const en = {
  ...
  'nav.contact': 'Contact',
  'nav.sponsorship': 'Sponsor us',
  'nav.label': 'Main navigation',
  'nav.brandHome': '{site} home',
  'theme.toggle': 'Toggle color theme',
  'footer.home': 'Home',
  'footer.registration': 'Register',
  'footer.about': 'About',
  ...
  'home.sponsorsEyebrow': 'Supported by',
  'home.sponsorsLabel': 'Sponsors',
  'home.organisersEyebrow': 'Organising committee',
  'home.organisersLabel': 'Organisers',
  'home.speakersEyebrow': 'Speakers',
  'home.speakersLabel': 'Plenary speakers',
  'home.keynote': 'Keynote',
  ...
  'submission.eyebrow': 'Submission',
  'programme.title': 'Programme',
  'programme.eyebrow': 'Programme',
  'programme.listLabel': 'Sessions on {day}',
  'programme.calendarEyebrow': 'Calendar',
  'programme.calendarHeading': 'Add to your calendar.',
  'programme.type.keynote': 'Keynote',
  'programme.type.poster': 'Posters',
  'programme.type.social': 'Social',
  'venue.title': 'Venue',
  'venue.eyebrow': 'Venue',
  'accommodation.title': 'Accommodation',
  'accommodation.eyebrow': 'Accommodation',
