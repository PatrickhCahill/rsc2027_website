...
export const ja: UIStrings = {
  ...
  'home.register': '参加登録',
  'home.sponsor': '協賛のご案内',
  'home.sponsorsEyebrow': '協賛',
  'home.sponsorsLabel': '協賛企業',
  'home.organisersEyebrow': '実行委員会',
  'home.organisersLabel': '主催者',
  'home.speakersEyebrow': '講演者',
  'home.speakersLabel': '確定した講演者',
  'home.keynote': '基調講演',
  ...
  'submission.title': '発表申込',
  'submission.eyebrow': '発表申込',
  'programme.title': 'プログラム',
  'programme.eyebrow': 'プログラム',
  'programme.listLabel': '{day}のセッション',
  'programme.calendarEyebrow': 'カレンダー',
  'programme.calendarHeading': 'カレンダーに追加する。',
  'programme.type.keynote': '基調講演',
  'programme.type.poster': 'ポスター',
  'programme.type.social': '交流',
  'venue.title': '会場',
  'venue.eyebrow': '会場',
  'accommodation.title': '宿泊',
  'accommodation.eyebrow': '宿泊',
